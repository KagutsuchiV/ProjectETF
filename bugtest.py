...
def send_data_to_server(asset_size, found_date, price):
    data = {
...
# 確認所有資料都已獲取，然後傳送資料
if asset_size and found_date and price:
    send_data_to_server(asset_size, found_date, price)
else:
    print("未獲取到所有必要的數據")
